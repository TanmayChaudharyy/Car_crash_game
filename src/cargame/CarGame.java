...
public class CarGame extends Applet implements Runnable, KeyListener
{
    ...
    String go="";
    String creator ="Tanmay_choudhary";
    ...
    public void start()
    {
        ...
        mycar_img=getImage(getDocumentBase(), "caryellow.png");
        obs_car1=getImage(getDocumentBase(), "carred.png");
        obs_car2=getImage(getDocumentBase(), "carred.png");
    ...
    public void paint(Graphics g)
    {
        ...
        g.setFont(new Font("Algerian", Font.PLAIN, 17));
        g.drawString("Creator : "+creator, 10, 50);
